local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/VeryAwesomeCapybara/Scripts/main/UI%20LIB.lua"))()
...
Keybind = 1,
Callback = function(ahlads)
getgenv().Speed = ahlads
end
})
